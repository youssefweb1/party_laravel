            ...
            <div class="card-body flex flex-col items-center justify-start gap-3">
                ...
                <form class="w-full" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex mb-4 email-container">
                        <span class="inline-flex items-center px-2 text-sm border-span-input-log border-custom-input bg-white rounded-l-xl">
                            <img class="w-8 p-2 bg-custoum-orange-50 rounded-md" src="{{ asset('assets/images/loginreg/email.svg') }}" alt="Email Icon">
                        </span>
                ...
                @enderror
                    ...
                    <div class="flex mb-4 password-container">
                        <span class="inline-flex items-center px-2 text-sm border-span-input-log border-custom-input bg-white rounded-l-xl">
                            <img class="w-9 p-2 bg-custoum-orange-50 rounded-md" src="{{ asset('assets/images/loginreg/pass.svg') }}" alt="Password Icon">
                        </span>
                        <div class="relative flex-1">
                            ...
                            <span id="togglePassword" class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-300 cursor-pointer">
                  ...
                  @enderror
                    <!-- forgot pass -->
                    <div class="text-sm flex justify-end mt-2 mb-4">
                        <a class="text-gray-400" href="{{ route('password.request') }}">Forgot Password?</a>
                    </div>
                    ...
                    <div class="text-sm flex justify-center text-gray-500 my-4 mb-4">
                        <a href="{{ route('register') }}">Or Sign With</a>
                    </div>
                
                    <!-- Social login buttons -->
                    <div class="flex items-center justify-center gap-3 text-gray-500 mt-4">
                        <a href="{{ route('facebook.login') }}" class="hover:bg-gray-100 duration-300 text-gray-500 border-custom-input rounded-xl w-1/3 py-3 flex items-center justify-center">
                            <img src="{{ asset('assets/images/loginreg/Icon zocial-facebook.svg') }}" alt="Facebook Icon" class="w-5 h-5">
                        </a>
                ...
                <div class="container mx-auto text-center mt-2">
                    <p class=" text-gray-500">
                        Are you new user?
                        <a href="{{ route('register') }}" class="text-custom-orange hover:text-gray-400  duration-300 underline">Register</a>
                    </p>
                </div>
